  ...
  return {
    ...
    playerPokemon: makePokemon(
      ...
      [
        ...
        { name: "HIDRO CANON", power: 45 },
        { name: "PISTOLA AGUA", power: 50 },
      ],
    ...
    setup() {
      this.dialogBox.displayText(
        "El Lider Tempranillo te desafia!",
        async () => {
    ...
    draw() {
      ...
      if (this.currentState === states.battleEnd) {
        if (this.npcPokemon.isFainted) {
          this.dialogBox.clearText();
          this.dialogBox.displayText(
            `${this.npcPokemon.name} se debilito! Has ganado!`
          );
        ...
        if (this.playerPokemon.isFainted) {
          this.dialogBox.clearText();
          this.dialogBox.displayText(
            `${this.playerPokemon.name} se debilito! Has perdido!`
          );
          this.currentState = states.winnerDeclared;
        }
      }
